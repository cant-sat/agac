            ...
            <div className="flex flex-col w-screen" >
                ...
                <div className="w-screen flex justify-evenly  *:bg-neutral-600/40 *:m-5 *:backdrop-blur-md *:p-5 *:rounded-xl *:border-neon *:border-[1.5px] *:text-center *:flex *:items-center *:flex-col *:*:my-3 flex-col lg:flex-row lg:flex-wrap lg:*:m-5 *:aspect-8/10">
                    <div>
                        ...
                        <img src="./images/launch1.PNG" alt="Launch 1 cover image" className="aspect-square rounded-sm w-[35vw] object-cover"/>
                    </div>
                    <div>
                        <div>
                        Launch Day 2
                        </div>
                        <img src="./images/launch2.jpg" alt="Launch 2 cover image" className=" rounded-sm w-[35vw] aspect-square object-cover"/>
                    </div>
                    <div>
                        <div>
                        Launch Day 3
